...
function Footer() {
  return (
    ...
    <Card.Footer className="text-muted">KOCHIOpp.Cochin Special Economic Zone (CSEZ),<br />
Seaport-Airport Road, Kakkanad. <br />Opening Time :
Monday to Sunday - 11:00 AM - 02:00 AM <br />702 532 2222, 0484 - 2952120 <br />For any assitance or enquiry</Card.Footer>
  </Card></div>
  )
}
